...
Structure complex components as multi-part compound headless components with a shared context where a single logical widget is decomposed into many small, focused subcomponents that communicate through shared internal shared state via context rather than prop drilling. Consumers then compose the pieces they need.
